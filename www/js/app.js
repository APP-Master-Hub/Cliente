...
/** Atualização Master Hub (Minhas Modificações) **/
   	    ...
   	    $(".startup_banner_carousel").css("height", banner_height+"px");
			...
			fillStartupBanner('startup_banner_carousel');
   	    /*setTimeout(function() {
   	    	initStartUpBanner();
   	    }, 100);*/
/** Fim da atualização **/
...
/** Atualização Master Hub (Minhas Modificações) **/
		case "coleta_form_location":
			...
			placeholder("#frm_coleta_form_location .street", "Street");
			placeholder("#frm_coleta_form_location .numero", "Numero");
			placeholder("#frm_coleta_form_location .state_name", "State/Region");
			placeholder("#frm_coleta_form_location .city_name", "City");
			placeholder("#frm_coleta_form_location .area_name", "Distric/Area/neighborhood");
			placeholder("#frm_coleta_form_location .location_name", "Floor/unit/Room #");
			placeholder("#frm_coleta_form_location .delivery_instruction", "Delivery instructions");
			placeholder("#frm_coleta_form_location .contact_phone", "Contact Number");

			processAjax('GetAddressFromCartLocation', '');

			break;

		case "coleta_form_select_location":
			processAjax('getColetaLocationBookDropDown', '');
		...
		case "pre_coleta_form_location":
			...
			placeholder("#frm_pre_coleta_form_location .street", "Street");
			placeholder("#frm_pre_coleta_form_location .numero", "Numero");
			placeholder("#frm_pre_coleta_form_location .state_name", "State/Region");
			placeholder("#frm_pre_coleta_form_location .city_name", "City");
			placeholder("#frm_pre_coleta_form_location .area_name", "Distric/Area/neighborhood");
			placeholder("#frm_pre_coleta_form_location .location_name", "Floor/unit/Room #");
			placeholder("#frm_pre_coleta_form_location .delivery_instruction", "Delivery instructions");
			placeholder("#frm_pre_coleta_form_location .contact_phone", "Contact Number");

			processAjax('GetAddressFromCartLocation', '');

			break;

		case "pre_coleta_form_select_location":
			processAjax('getPreColetaLocationBookDropDown', '');
		...
		case "retorno_form_location":
			...
			placeholder("#frm_retorno_form_location .street", "Street");
			placeholder("#frm_retorno_form_location .numero", "Numero");
			placeholder("#frm_retorno_form_location .state_name", "State/Region");
			placeholder("#frm_retorno_form_location .city_name", "City");
			placeholder("#frm_retorno_form_location .area_name", "Distric/Area/neighborhood");
			placeholder("#frm_retorno_form_location .location_name", "Floor/unit/Room #");
			placeholder("#frm_retorno_form_location .delivery_instruction", "Delivery instructions");
			placeholder("#frm_retorno_form_location .contact_phone", "Contact Number");

			processAjax('GetAddressFromCartLocation', '');

			break;

		case "retorno_form_select_location":
			processAjax('getRetornoLocationBookDropDown', '');
...
/** Atualização Master Hub (Minhas Modificações) **/
					...
					case "getPreColetaBookDropDown":
						tpl = fillColetaBook(data.details.data);
						$('.coleta_book_wrap').html(tpl);
						break;

					case "getRetornoBookDropDown":
						tpl = fillColetaBook(data.details.data);
						$('.coleta_book_wrap').html(tpl);
						break;
/** Fim da atualização **/
...
/** Atualização Master Hub (Minhas Modificações) **/
					...
					case "setColetaBook":
					case "setColetaLocation":
					case "setColetaBookLocation":
						onsenNavigator.popPage();

						$(".coleta_address").val(data.details.complete_address);

						printColetaAddress(data.details.complete_address);
	        	   ...
	        	   //if( action=="setColetaAddress" || action=="setColetaBook"){
	        	   if( action=="setColetaAddress" || action=="setColetaBook"){
	        	   	
	        	   	   if($old_location = getCurrentLocation()){
	        	   	  	  setStorage("coleta_old_lat", $old_location.lat );
	        	   	  	  setStorage("coleta_old_lng", $old_location.lng );
	        	   	   }
	        	   	  
		        	   setStorage("coleta_lat", data.details.lat );
		               setStorage("coleta_lng", data.details.lng );		
		               setStorage("coleta_address", data.details.complete_address );	
                      ...
                      setStorage("geocoded_address", JSON.stringify($_addresscoleta) );		
	        	   }
					...
					case "setPreColetaAddress":
					case "setPreColetaBook":
					case "setPreColetaLocation":
					case "setPreColetaBookLocation":
						onsenNavigator.popPage();

						$(".pre_coleta_address").val(data.details.complete_address);

						printPreColetaAddress(data.details.complete_address);
	        	   ...
	        	   //if( action=="setPreColetaAddress" || action=="setPreColetaBook"){
	        	   if( action=="setPreColetaAddress" || action=="setPreColetaBook"){
	        	   	
	        	   	   if($old_location = getCurrentLocation()){
	        	   	  	  setStorage("precoleta_old_lat", $old_location.lat );
	        	   	  	  setStorage("precoleta_old_lng", $old_location.lng );
	        	   	   }
	        	   	  
		        	   setStorage("precoleta_lat", data.details.lat );
		               setStorage("precoleta_lng", data.details.lng );		
		               setStorage("precoleta_address", data.details.complete_address );	
                      ...
                      setStorage("geocoded_address", JSON.stringify($_addressprecoleta) );		
	        	   }
					...
					case "setRetornoBook":
					case "setRetornoLocation":
					case "setRetornoBookLocation":
						onsenNavigator.popPage();

						$(".retorno_address").val(data.details.complete_address);

						printRetornoAddress(data.details.complete_address);
	        	   ...
	        	   //if( action=="setRetornoAddress" || action=="setRetornoBook"){
	        	   if( action=="setRetornoAddress" || action=="setRetornoBook"){
	        	   	
	        	   	   if($old_location = getCurrentLocation()){
	        	   	  	  setStorage("retorno_old_lat", $old_location.lat );
	        	   	  	  setStorage("retorno_old_lng", $old_location.lng );
	        	   	   }
	        	   	  
		        	   setStorage("retorno_lat", data.details.lat );
		               setStorage("retorno_lng", data.details.lng );		
		               setStorage("retorno_address", data.details.complete_address );	
                      ...
                      setStorage("geocoded_address", JSON.stringify($_addressretorno) );		
	        	   }
...
/** Atualização Master Hub (Minhas Modificações) **/
					...
					case "getPreColetaLocationBookDropDown":
						tpl = fillPreColetaBook(data.details.data);
						$('#pre_coleta_form_select_location .pre_coleta_book_wrap').html(tpl);
						break;

					case "getRetornoLocationBookDropDown":
...
initColetaAddress = function () {
	...
	if (has_addressbook == 1) {
		if (isLocation()) {
			showPage('coleta_form_select_location.html');
		}
		else {
			showPage('coleta_form_select.html');
		}
	}
	else {
		if (isLocation()) {
			showPage('coleta_form_location.html');
		}
		else {
			showPage('coleta_form.html');
		}
	}
};
...
var setColetaAddress = function () {
	$(".frm_coleta").validate({
		submitHandler: function (form) {
			var params = $(".frm_coleta").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setColetaAddress', params);
		}
	});
	$(".frm_coleta").submit();
};
...
initPreColetaAddress = function () {
	has_addressbook = $(".has_addressbook").val();
	if (has_addressbook == 1) {
		if (isLocation()) {
			showPage('pre_coleta_form_select_location.html');
		}
		else {
			showPage('pre_coleta_form_select.html');
		}
	}
	else {
		if (isLocation()) {
			showPage('pre_coleta_form_location.html');
		}
		else {
			showPage('pre_coleta_form.html');
		}
	}
};

var setPreColetaAddress = function () {
	$(".frm_pre_coleta").validate({
		submitHandler: function (form) {
			var params = $(".frm_pre_coleta").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setPreColetaAddress', params);
		}
	});
	$(".frm_pre_coleta").submit();
};

var printPreColetaAddress = function (address) {
	$(".pre_coleta_address_label").html(address);
};

initRetornoAddress = function () {
	has_addressbook = $(".has_addressbook").val();
	if (has_addressbook == 1) {
		if (isLocation()) {
			showPage('retorno_form_select_location.html');
		}
		else {
			showPage('retorno_form_select.html');
		}
	}
	else {
		if (isLocation()) {
			showPage('retorno_form_location.html');
		}
		else {
			showPage('retorno_form.html');
		}
	}
};

var setRetornoAddress = function () {
	$(".frm_retorno").validate({
		submitHandler: function (form) {
			var params = $(".frm_retorno").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setRetornoAddress', params);
		}
	});
	$(".frm_retorno").submit();
};
...
/** Atualização Master Hub (Minhas Modificações) **/
		case "prestacao_servico":
			var street = $(".delivery_address").val();
			if (empty(street)) {
				showAlert(t("Please enter service address"));
				return;
			}
			...
			if (required_delivery_time == 1 && delivery_asap_val == false) {
				delivery_time_set = getStorage("delivery_time_set");
				if (empty(delivery_time_set)) {
					showAlert(t("Service time is required"));
					return;
				}
			}
			break;
...
setColetaBook = function () {
	$(".frm_coleta_form_select").validate({
		submitHandler: function (form) {
			...
			var params = $(".frm_coleta_form_select").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setColetaBook', params);
		}
	});
	$(".frm_coleta_form_select").submit();
};

setPreColetaBook = function () {
	$(".frm_pre_coleta_form_select").validate({
		submitHandler: function (form) {

			setStorage("customer_number", $(".contact_phone").val());

			var params = $(".frm_pre_coleta_form_select").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setPreColetaBook', params);
		}
	});
	$(".frm_pre_coleta_form_select").submit();
};

setRetornoBook = function () {
	$(".frm_retorno_form_select").validate({
		submitHandler: function (form) {

			setStorage("customer_number", $(".contact_phone").val());

			var params = $(".frm_retorno_form_select").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setRetornoBook', params);
		}
	});
...
var setColetaLocation = function () {
	$(".frm_coleta_form_location").validate({
		submitHandler: function (form) {
			var params = $(".frm_coleta_form_location").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setColetaLocation', params);
		}
	});
	$(".frm_coleta_form_location").submit();
};

setColetaBookLocation = function () {
	$(".frm_coleta_form_select_location").validate({
		submitHandler: function (form) {

			setStorage("customer_number", $(".contact_phone").val());

			var params = $(".frm_coleta_form_select_location").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setColetaBookLocation', params);
		}
	});
	$(".frm_coleta_form_select_location").submit();
};

fillColetaForm = function () {
	dump('fillColetaForm');
	if (location_res = getLocationData()) {
		dump(location_res);
		switch (location_res.location_mode) {
			case 1:
				...
				$.each(location_res, function (key, val) {
					setValue("#coleta_form_location ." + key, val);
				});
...
var setPreColetaLocation = function () {
	$(".frm_pre_coleta_form_location").validate({
		submitHandler: function (form) {
			var params = $(".frm_pre_coleta_form_location").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setPreColetaLocation', params);
		}
	});
	$(".frm_pre_coleta_form_location").submit();
};

setPreColetaBookLocation = function () {
	$(".frm_pre_coleta_form_select_location").validate({
		submitHandler: function (form) {

			setStorage("customer_number", $(".contact_phone").val());

			var params = $(".frm_pre_coleta_form_select_location").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setPreColetaBookLocation', params);
		}
	});
	$(".frm_pre_coleta_form_select_location").submit();
};

fillPreColetaForm = function () {
	dump('fillPreColetaForm');
	if (location_res = getLocationData()) {
		dump(location_res);
		switch (location_res.location_mode) {
			case 1:
				...
				$.each(location_res, function (key, val) {
					setValue("#pre_coleta_form_location ." + key, val);
				});
...
var setRetornoLocation = function () {
	$(".frm_retorno_form_location").validate({
		submitHandler: function (form) {
			var params = $(".frm_retorno_form_location").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setRetornoLocation', params);
		}
	});
	$(".frm_retorno_form_location").submit();
};

setRetornoBookLocation = function () {
	$(".frm_retorno_form_select_location").validate({
		submitHandler: function (form) {

			setStorage("customer_number", $(".contact_phone").val());

			var params = $(".frm_retorno_form_select_location").serialize();
			params += "&merchant_id=" + getActiveMerchantID();
			processAjax('setRetornoBookLocation', params);
		}
	});
	$(".frm_retorno_form_select_location").submit();
};

fillRetornoForm = function () {
	dump('fillRetornoForm');
	if (location_res = getLocationData()) {
		dump(location_res);
		switch (location_res.location_mode) {
			case 1:
				...
				$.each(location_res, function (key, val) {
					setValue("#retorno_form_location ." + key, val);
				});
